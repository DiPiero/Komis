    ...
    public class MockSamochodRepository : ISamochodRepository
    {
        ...
        private void ZaladujSamochody()
        {
            samochody = new List<Samochod>
            {
                ...
                new Samochod { Id=3, Marka="BMW", Model="X4", RokProdukcji = 2017, Przebieg = "4 300 km", Pojemnosc = "1 995 cm3", RodzajPaliwa = "benzyna", Moc = "190 KM", Opis = "BMW X4 20d xDrive. Samochód krajowy. Samochód serwisowany. Wystawiamy fakturę VAT 23%. Samochód bezwypadkowy. I właściciel.", Cena = 194000M, ZdjecieUrl = "/images/bmwx4.jpg", MiniaturkaUrl = "/images/bmwx4.jpg", JestSamochodemTygodnia = true},
                new Samochod { Id=4, Marka="Chevrolet", Model="Corvette", RokProdukcji = 1972, Przebieg = "28 000 km", Pojemnosc = "5 700 cm3", RodzajPaliwa = "benzyna", Moc = "300 KM", Opis = "Corvetta jest w świetnym stanie wizualnym i mechanicznym. Oczywiście jest ZAREJESTROWANA i ubezpieczona w PL", Cena = 90000M, ZdjecieUrl = "/images/chevroletCorvette.jpg", MiniaturkaUrl = "/images/chevroletCorvette.jpg", JestSamochodemTygodnia = true},
                ...
                new Samochod { Id=6, Marka="Jaguar", Model="XKR", RokProdukcji = 2006, Przebieg = "78 000 km", Pojemnosc = "5 000 cm3", RodzajPaliwa = "benzyna", Moc = "510 KM", Opis = "Przedstawiam Państwu wyjątkowe auto jakim jest Jaguar XKR, a zwłaszcza ten egzemplarz. Jaguar XKR to ikona światowej i brytyjskiej motoryzacj, a przeda wszystkim kontynuator legendarnego już Jaguara E-type, przez wielu uważany za najpiękniejsze auto w historii motoryzacji.", Cena = 200000M, ZdjecieUrl = "/images/jaguar.jpg", MiniaturkaUrl = "/images/jaguar.jpg", JestSamochodemTygodnia = true}
            };
        }
